...
const SellList = ({route,navigation}:Props) =>{
    ...
    return (
        ...
        <View>
            ...
            <Button style={styles.floatingRegisterButtonStyle} onPress={()=>navigation.navigate('SellRegister')}>
                        <Icon
